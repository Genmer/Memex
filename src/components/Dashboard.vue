...
const colors = [
  { bg: 'from-blue-500/20 to-indigo-500/10', border: 'border-blue-500/20', text: 'text-blue-400', icon: 'text-blue-500/20 group-hover:text-blue-500/30' },
  { bg: 'from-purple-500/20 to-pink-500/10', border: 'border-purple-500/20', text: 'text-purple-400', icon: 'text-purple-500/20 group-hover:text-purple-500/30' },
  { bg: 'from-amber-500/20 to-orange-500/10', border: 'border-amber-500/20', text: 'text-amber-400', icon: 'text-amber-500/20 group-hover:text-amber-500/30' },
  { bg: 'from-teal-500/20 to-emerald-500/10', border: 'border-teal-500/20', text: 'text-teal-400', icon: 'text-teal-500/20 group-hover:text-teal-500/30' },
  { bg: 'from-rose-500/20 to-red-500/10', border: 'border-rose-500/20', text: 'text-rose-400', icon: 'text-rose-500/20 group-hover:text-rose-500/30' },
  { bg: 'from-sky-500/20 to-blue-500/10', border: 'border-sky-500/20', text: 'text-sky-400', icon: 'text-sky-500/20 group-hover:text-sky-500/30' },
]
...
<template>
  <div class="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
    ...
    <div class="flex items-center justify-between">
      ...
      <button @click="refreshAll" class="flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-white/10 rounded-lg text-sm text-white/70 hover:text-white transition-colors border border-white/10 shadow-inner">
        <Activity :size="14" />
        {{ t('dashboard.refresh') }}
      </button>
    </div>
        ...
        <div class="flex items-center justify-center gap-10 flex-1">
          ...
          <div class="space-y-2.5">
            <div v-for="(seg, i) in donutSegments" :key="i" class="flex items-center gap-3">
              ...
              <span class="text-xs text-white/70 w-24 truncate">{{ seg.name }}</span>
